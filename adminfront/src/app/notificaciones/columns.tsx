...
export const columns = (handleMarkAsRead: (id: string) => void, handleMarkAsUnread: (id: string) => void): ColumnDef<Notificacion>[] => [
    {
        accessorKey: "asunto",
        header: "Asunto",
        cell: ({ row }) => {
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            const diff = new Date().getTime() - (new Date(fecha).getTime() - 5 * 60 * 60 * 1000);
